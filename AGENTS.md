...
config/fork-url  optional complete push URL used verbatim to initialize the no-mistakes gate; LOCAL, gitignored; inherited by secondmate homes; takes precedence over config/fork-owner; see docs/configuration.md "Push target for the no-mistakes gate"
